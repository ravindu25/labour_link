<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'GET') {
        if (isset($_GET['bookingId'])) {
            ...
            // Getting all the bookings
            $sql_get_all_bookings = "select Booking.*, Worker.First_Name AS Worker_First_Name, Worker.Last_Name AS Worker_Last_Name, Customer.First_Name AS Customer_First_Name, Customer.Last_Name AS Customer_Last_Name from Booking inner join User AS Worker ON Booking.Worker_ID = Worker.User_ID inner join User AS Worker ON Booking.Worker_ID = Worker.User_ID where Booking.Worker_ID = $workerId ORDER BY Booking.Created_Date DESC";
